...
const JDM = {
  ...
  AZR60:  { brand: 'Toyota', model: 'Noah', from: 2001, to: 2007, alt: 'Voxy' },
  AZR65:  { brand: 'Toyota', model: 'Noah', from: 2001, to: 2007, alt: 'Voxy' },
  ZRR75:  { brand: 'Toyota', model: 'Noah', from: 2007, to: 2014, alt: 'Voxy' },
  ZRR85:  { brand: 'Toyota', model: 'Noah', from: 2014, to: 2022, alt: 'Voxy' },
  ACA33:  { brand: 'Toyota', model: 'Vanguard', from: 2007, to: 2013 },
  ACA38:  { brand: 'Toyota', model: 'Vanguard', from: 2007, to: 2013 },
  GSA33:  { brand: 'Toyota', model: 'Vanguard', from: 2007, to: 2013 },
  ...
  GRS190: { brand: 'Lexus', model: 'GS', from: 2005, to: 2011 },
  GRS191: { brand: 'Lexus', model: 'GS', from: 2005, to: 2011 },
  UZS190: { brand: 'Lexus', model: 'GS', from: 2005, to: 2011 },
  GWS191: { brand: 'Lexus', model: 'GS', from: 2005, to: 2011, alt: 'hybrid' },
  GRL10:  { brand: 'Lexus', model: 'GS', from: 2012, to: 2020 },
  GRL11:  { brand: 'Lexus', model: 'GS', from: 2012, to: 2020 },
  AWL10:  { brand: 'Lexus', model: 'GS', from: 2012, to: 2020, alt: 'hybrid' },
  URL10:  { brand: 'Lexus', model: 'GS', from: 2012, to: 2020 },
  ...
  PNZ50: { brand: 'Nissan', model: 'Murano', from: 2002, to: 2007 },
  PZ50:  { brand: 'Nissan', model: 'Murano', from: 2002, to: 2007 },
  TZ50:  { brand: 'Nissan', model: 'Murano', from: 2002, to: 2007 },
  TZ51:  { brand: 'Nissan', model: 'Murano', from: 2008, to: 2014 },
  PNZ51: { brand: 'Nissan', model: 'Murano', from: 2008, to: 2014 },
  TNZ51: { brand: 'Nissan', model: 'Murano', from: 2008, to: 2014 },
  ...
  VBH: { brand: 'Subaru', model: 'WRX', from: 2022, to: null },
  ...
  CV4W: { brand: 'Mitsubishi', model: 'Delica', from: 2007, to: null, alt: 'D:5' },
  CV2W: { brand: 'Mitsubishi', model: 'Delica', from: 2007, to: null, alt: 'D:5' },
