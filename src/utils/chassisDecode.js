...
const JDM = {
  ...
  FZJ80:  { brand: 'Toyota', model: 'Land Cruiser', from: 1990, to: 1997 },
  HDJ80:  { brand: 'Toyota', model: 'Land Cruiser', from: 1990, to: 1997 },
  HZJ80:  { brand: 'Toyota', model: 'Land Cruiser', from: 1990, to: 1997 },
  UZJ100: { brand: 'Toyota', model: 'Land Cruiser', from: 1998, to: 2007, alt: 'Lexus LX470' },
  HDJ100: { brand: 'Toyota', model: 'Land Cruiser', from: 1998, to: 2007 },
  FZJ100: { brand: 'Toyota', model: 'Land Cruiser', from: 1998, to: 2007 },
  URJ202: { brand: 'Toyota', model: 'Land Cruiser', from: 2007, to: 2021 },
  ...
  GRX121: { brand: 'Toyota', model: 'Mark X', from: 2004, to: 2009 },
  GRX125: { brand: 'Toyota', model: 'Mark X', from: 2004, to: 2009 },
  GRX130: { brand: 'Toyota', model: 'Mark X', from: 2009, to: 2019 },
  GRX133: { brand: 'Toyota', model: 'Mark X', from: 2009, to: 2019 },
  GRX135: { brand: 'Toyota', model: 'Mark X', from: 2009, to: 2019 },
  GRS180: { brand: 'Toyota', model: 'Crown', from: 2003, to: 2008 },
  GRS182: { brand: 'Toyota', model: 'Crown', from: 2003, to: 2008 },
  GRS183: { brand: 'Toyota', model: 'Crown', from: 2003, to: 2008 },
  GRS200: { brand: 'Toyota', model: 'Crown', from: 2008, to: 2012 },
  GRS201: { brand: 'Toyota', model: 'Crown', from: 2008, to: 2012 },
  GRS202: { brand: 'Toyota', model: 'Crown', from: 2008, to: 2012 },
  GRS210: { brand: 'Toyota', model: 'Crown', from: 2012, to: 2018 },
  ARS210: { brand: 'Toyota', model: 'Crown', from: 2012, to: 2018 },
  GRS214: { brand: 'Toyota', model: 'Crown', from: 2012, to: 2018 },
  ...
  GX90:   { brand: 'Toyota', model: 'Mark II', from: 1992, to: 1996 },
  JZX90:  { brand: 'Toyota', model: 'Mark II', from: 1992, to: 1996 },
  JZX91:  { brand: 'Toyota', model: 'Mark II', from: 1992, to: 1996 },
  SX90:   { brand: 'Toyota', model: 'Mark II', from: 1992, to: 1996 },
  LX90:   { brand: 'Toyota', model: 'Mark II', from: 1992, to: 1996 },
  GX100:  { brand: 'Toyota', model: 'Mark II', from: 1997, to: 2000 },
  JZX100: { brand: 'Toyota', model: 'Mark II', from: 1997, to: 2000 },
  JZX101: { brand: 'Toyota', model: 'Mark II', from: 1997, to: 2000 },
  JZX105: { brand: 'Toyota', model: 'Mark II', from: 1997, to: 2000 },
  LX100:  { brand: 'Toyota', model: 'Mark II', from: 1997, to: 2000 },
  GX110:  { brand: 'Toyota', model: 'Mark II', from: 2001, to: 2004 },
  JZX110: { brand: 'Toyota', model: 'Mark II', from: 2001, to: 2004 },
  JZX115: { brand: 'Toyota', model: 'Mark II', from: 2001, to: 2004 },
  GX115:  { brand: 'Toyota', model: 'Mark II', from: 2001, to: 2004 },
  NZT240: { brand: 'Toyota', model: 'Allion', from: 2001, to: 2007 },
  ZZT240: { brand: 'Toyota', model: 'Allion', from: 2001, to: 2007 },
  ZZT245: { brand: 'Toyota', model: 'Allion', from: 2001, to: 2007 },
  AZT240: { brand: 'Toyota', model: 'Allion', from: 2001, to: 2007 },
  NZT260: { brand: 'Toyota', model: 'Allion', from: 2008, to: 2021 },
  ZRT260: { brand: 'Toyota', model: 'Allion', from: 2008, to: 2021 },
  ZRT261: { brand: 'Toyota', model: 'Allion', from: 2008, to: 2021 },
  ZRT265: { brand: 'Toyota', model: 'Allion', from: 2008, to: 2021 },
  ANM10:  { brand: 'Toyota', model: 'Isis', from: 2004, to: 2017 },
  ANM15:  { brand: 'Toyota', model: 'Isis', from: 2004, to: 2017 },
  ZNM10:  { brand: 'Toyota', model: 'Isis', from: 2004, to: 2017 },
  ZGM10:  { brand: 'Toyota', model: 'Isis', from: 2004, to: 2017 },
  ZGM11:  { brand: 'Toyota', model: 'Isis', from: 2004, to: 2017 },
  ZGM15:  { brand: 'Toyota', model: 'Isis', from: 2004, to: 2017 },
  NCP100: { brand: 'Toyota', model: 'Ractis', from: 2005, to: 2009 },
  NCP105: { brand: 'Toyota', model: 'Ractis', from: 2005, to: 2009 },
  NCP120: { brand: 'Toyota', model: 'Ractis', from: 2010, to: 2016 },
  NCP122: { brand: 'Toyota', model: 'Ractis', from: 2010, to: 2016 },
  NSP120: { brand: 'Toyota', model: 'Ractis', from: 2010, to: 2016 },
  KGC10:  { brand: 'Toyota', model: 'Passo', from: 2004, to: 2009 },
  QNC10:  { brand: 'Toyota', model: 'Passo', from: 2004, to: 2009 },
  KGC30:  { brand: 'Toyota', model: 'Passo', from: 2010, to: 2015, alt: 'Daihatsu Boon' },
  KGC35:  { brand: 'Toyota', model: 'Passo', from: 2010, to: 2015, alt: 'Daihatsu Boon' },
  NGC30:  { brand: 'Toyota', model: 'Passo', from: 2010, to: 2015, alt: 'Daihatsu Boon' },
  M700A:  { brand: 'Toyota', model: 'Passo', from: 2016, to: 2023, alt: 'Daihatsu Boon' },
  M710A:  { brand: 'Toyota', model: 'Passo', from: 2016, to: 2023, alt: 'Daihatsu Boon' },
  EP71:   { brand: 'Toyota', model: 'Starlet', from: 1984, to: 1989 },
  EP82:   { brand: 'Toyota', model: 'Starlet', from: 1990, to: 1995 },
  EP91:   { brand: 'Toyota', model: 'Starlet', from: 1996, to: 1999 },
  ST182:  { brand: 'Toyota', model: 'Celica', from: 1989, to: 1993 },
  ST183:  { brand: 'Toyota', model: 'Celica', from: 1989, to: 1993 },
  ST185:  { brand: 'Toyota', model: 'Celica', from: 1989, to: 1993, alt: 'GT-Four' },
  ST202:  { brand: 'Toyota', model: 'Celica', from: 1994, to: 1999 },
  ST205:  { brand: 'Toyota', model: 'Celica', from: 1994, to: 1999, alt: 'GT-Four' },
  AT200:  { brand: 'Toyota', model: 'Celica', from: 1994, to: 1999 },
  ZZT230: { brand: 'Toyota', model: 'Celica', from: 2000, to: 2006 },
  ZZT231: { brand: 'Toyota', model: 'Celica', from: 2000, to: 2006 },
  ACU20:  { brand: 'Toyota', model: 'Kluger', from: 2000, to: 2007 },
  MCU20:  { brand: 'Toyota', model: 'Kluger', from: 2000, to: 2007 },
  MCU25:  { brand: 'Toyota', model: 'Kluger', from: 2000, to: 2007 },
  GSU40:  { brand: 'Toyota', model: 'Kluger', from: 2008, to: 2013 },
  GSU45:  { brand: 'Toyota', model: 'Kluger', from: 2008, to: 2013 },
  ASU40:  { brand: 'Toyota', model: 'Kluger', from: 2008, to: 2013 },
  GSU50:  { brand: 'Toyota', model: 'Kluger', from: 2014, to: 2020 },
  GSU55:  { brand: 'Toyota', model: 'Kluger', from: 2014, to: 2020 },
  ASU50:  { brand: 'Toyota', model: 'Kluger', from: 2014, to: 2020 },
  SXM10:  { brand: 'Toyota', model: 'Ipsum', from: 1996, to: 2001 },
  SXM15:  { brand: 'Toyota', model: 'Ipsum', from: 1996, to: 2001 },
  CXM10:  { brand: 'Toyota', model: 'Ipsum', from: 1996, to: 2001 },
  ACM21:  { brand: 'Toyota', model: 'Ipsum', from: 2002, to: 2009 },
  ACM26:  { brand: 'Toyota', model: 'Ipsum', from: 2002, to: 2009 },
  AE100:  { brand: 'Toyota', model: 'Corolla', from: 1991, to: 1995 },
  AE101:  { brand: 'Toyota', model: 'Corolla', from: 1991, to: 1995 },
  EE100:  { brand: 'Toyota', model: 'Corolla', from: 1991, to: 1995 },
  AE110:  { brand: 'Toyota', model: 'Corolla', from: 1996, to: 2001 },
  AE111:  { brand: 'Toyota', model: 'Corolla', from: 1996, to: 2001 },
  EE111:  { brand: 'Toyota', model: 'Corolla', from: 1996, to: 2001 },
  AT170:  { brand: 'Toyota', model: 'Corona', from: 1988, to: 1992 },
  ST170:  { brand: 'Toyota', model: 'Corona', from: 1988, to: 1992 },
  AT190:  { brand: 'Toyota', model: 'Corona', from: 1993, to: 1998 },
  ST191:  { brand: 'Toyota', model: 'Corona', from: 1993, to: 1998 },
  GSJ15:  { brand: 'Toyota', model: 'FJ Cruiser', from: 2006, to: 2018 },
  ...
  UCF30:  { brand: 'Lexus', model: 'LS', from: 2000, to: 2006 },
  UCF31:  { brand: 'Lexus', model: 'LS', from: 2000, to: 2006 },
  USF41:  { brand: 'Lexus', model: 'LS', from: 2006, to: 2017 },
  UVF45:  { brand: 'Lexus', model: 'LS', from: 2006, to: 2017, alt: 'LS600h (hybrid)' },
  VXFA50: { brand: 'Lexus', model: 'LS', from: 2017, to: null },
  VXFA55: { brand: 'Lexus', model: 'LS', from: 2017, to: null },
  GVF50:  { brand: 'Lexus', model: 'LS', from: 2017, to: null, alt: 'LS500h (hybrid)' },
  URJ201: { brand: 'Lexus', model: 'LX', from: 2007, to: 2021 },
  VJA310: { brand: 'Lexus', model: 'LX', from: 2021, to: null },
  UZJ120: { brand: 'Lexus', model: 'GX', from: 2003, to: 2009 },
  URJ150: { brand: 'Lexus', model: 'GX', from: 2010, to: 2023 },
  URZ100: { brand: 'Lexus', model: 'LC', from: 2017, to: null },
  ASC10:  { brand: 'Lexus', model: 'RC', from: 2014, to: null },
  GSC10:  { brand: 'Lexus', model: 'RC', from: 2014, to: null },
  // RC F is USC10 (2UR-GSE V8); GSC10 is the RC350 V6. This row had the badge
  // on the wrong code.
  USC10:  { brand: 'Lexus', model: 'RC', from: 2014, to: null, alt: 'RC F' },
  ...
  RG1: { brand: 'Honda', model: 'Stepwgn', from: 2005, to: 2009 },
  RG3: { brand: 'Honda', model: 'Stepwgn', from: 2005, to: 2009 },
  ...
  ZE3: { brand: 'Honda', model: 'Insight', from: 2009, to: 2014 },
  ...
  RR1: { brand: 'Honda', model: 'Elysion', from: 2004, to: 2013 },
  RR2: { brand: 'Honda', model: 'Elysion', from: 2004, to: 2013 },
  RR3: { brand: 'Honda', model: 'Elysion', from: 2004, to: 2013 },
  RR4: { brand: 'Honda', model: 'Elysion', from: 2004, to: 2013 },
  RR5: { brand: 'Honda', model: 'Elysion', from: 2004, to: 2013 },
  RR6: { brand: 'Honda', model: 'Elysion', from: 2004, to: 2013 },
  KA9: { brand: 'Honda', model: 'Legend', from: 1996, to: 2004 },
  KB1: { brand: 'Honda', model: 'Legend', from: 2005, to: 2012 },
  KB2: { brand: 'Honda', model: 'Legend', from: 2005, to: 2012 },
  KC2: { brand: 'Honda', model: 'Legend', from: 2015, to: 2021, alt: 'hybrid' },
  BA4: { brand: 'Honda', model: 'Prelude', from: 1987, to: 1991 },
  BA5: { brand: 'Honda', model: 'Prelude', from: 1987, to: 1991 },
  BB1: { brand: 'Honda', model: 'Prelude', from: 1992, to: 1996 },
  BB4: { brand: 'Honda', model: 'Prelude', from: 1992, to: 1996 },
  BB5: { brand: 'Honda', model: 'Prelude', from: 1997, to: 2001 },
  BB6: { brand: 'Honda', model: 'Prelude', from: 1997, to: 2001 },
  BB8: { brand: 'Honda', model: 'Prelude', from: 1997, to: 2001 },
  GJ1: { brand: 'Honda', model: 'Airwave', from: 2005, to: 2010 },
  GJ2: { brand: 'Honda', model: 'Airwave', from: 2005, to: 2010 },
  ...
  ZE1:  { brand: 'Nissan', model: 'Leaf', from: 2017, to: null, alt: 'also the Honda Insight (1999-2006) code' },
  ...
  PS13:   { brand: 'Nissan', model: 'Silvia', from: 1988, to: 1993 },
  Y50:    { brand: 'Nissan', model: 'Fuga', from: 2004, to: 2009 },
  PY50:   { brand: 'Nissan', model: 'Fuga', from: 2004, to: 2009 },
  GY50:   { brand: 'Nissan', model: 'Fuga', from: 2004, to: 2009 },
  Y51:    { brand: 'Nissan', model: 'Fuga', from: 2010, to: 2022 },
  KY51:   { brand: 'Nissan', model: 'Fuga', from: 2010, to: 2022 },
  HY51:   { brand: 'Nissan', model: 'Fuga', from: 2010, to: 2022, alt: 'hybrid' },
  Z11:    { brand: 'Nissan', model: 'Cube', from: 2002, to: 2008 },
  BZ11:   { brand: 'Nissan', model: 'Cube', from: 2002, to: 2008 },
  YZ11:   { brand: 'Nissan', model: 'Cube', from: 2002, to: 2008 },
  Z12:    { brand: 'Nissan', model: 'Cube', from: 2009, to: 2019 },
  NZ12:   { brand: 'Nissan', model: 'Cube', from: 2009, to: 2019 },
  Y60:    { brand: 'Nissan', model: 'Patrol', from: 1987, to: 1997 },
  Y61:    { brand: 'Nissan', model: 'Patrol', from: 1998, to: 2009 },
  Y62:    { brand: 'Nissan', model: 'Patrol', from: 2010, to: 2023 },
  P10:    { brand: 'Nissan', model: 'Primera', from: 1991, to: 1995 },
  P11:    { brand: 'Nissan', model: 'Primera', from: 1996, to: 2001 },
  P12:    { brand: 'Nissan', model: 'Primera', from: 2002, to: 2007 },
  R50:    { brand: 'Nissan', model: 'Pathfinder', from: 1996, to: 2004 },
  R51:    { brand: 'Nissan', model: 'Pathfinder', from: 2005, to: 2012 },
  R52:    { brand: 'Nissan', model: 'Pathfinder', from: 2013, to: 2020 },
  U13:    { brand: 'Nissan', model: 'Bluebird', from: 1992, to: 1996 },
  HU13:   { brand: 'Nissan', model: 'Bluebird', from: 1992, to: 1996 },
  U14:    { brand: 'Nissan', model: 'Bluebird', from: 1997, to: 2001 },
  HU14:   { brand: 'Nissan', model: 'Bluebird', from: 1997, to: 2001 },
  M20:    { brand: 'Nissan', model: 'Evalia', from: 2013, to: 2020 },
  ...
  FC3S:   { brand: 'Mazda', model: 'RX-7', from: 1985, to: 1991 },
  FD3S:   { brand: 'Mazda', model: 'RX-7', from: 1992, to: 2002 },
  LW3W:   { brand: 'Mazda', model: 'MPV', from: 1999, to: 2005 },
  LWEW:   { brand: 'Mazda', model: 'MPV', from: 1999, to: 2005 },
  LW5W:   { brand: 'Mazda', model: 'MPV', from: 1999, to: 2005 },
  LY3P:   { brand: 'Mazda', model: 'MPV', from: 2006, to: 2016 },
  ...
  CP8W:  { brand: 'Mazda', model: 'Premacy', from: 1999, to: 2005 },
  CPEW:  { brand: 'Mazda', model: 'Premacy', from: 1999, to: 2005 },
  ...
  YA5: { brand: 'Subaru', model: 'Exiga', from: 2008, to: 2015 },
  ...
  // E52A / CU2W need exact rows: without them the prefix loop decoded a Galant
  // as a Nissan Elgrand (E52) and an Airtrek as a Honda Accord (CU2).
  E52A:   { brand: 'Mitsubishi', model: 'Galant', from: 1992, to: 1996 },
  E55A:   { brand: 'Mitsubishi', model: 'Galant', from: 1992, to: 1996 },
  E57A:   { brand: 'Mitsubishi', model: 'Galant', from: 1992, to: 1996 },
  EA3A:   { brand: 'Mitsubishi', model: 'Galant', from: 1997, to: 2003 },
  EA5A:   { brand: 'Mitsubishi', model: 'Galant', from: 1997, to: 2003 },
  CU2W:   { brand: 'Mitsubishi', model: 'Airtrek', from: 2001, to: 2005 },
  CU4W:   { brand: 'Mitsubishi', model: 'Airtrek', from: 2001, to: 2005 },
  CU5W:   { brand: 'Mitsubishi', model: 'Airtrek', from: 2001, to: 2005 },
  N33W:   { brand: 'Mitsubishi', model: 'Space Wagon', from: 1991, to: 1998 },
  N34W:   { brand: 'Mitsubishi', model: 'Space Wagon', from: 1991, to: 1998 },
  N43W:   { brand: 'Mitsubishi', model: 'Space Wagon', from: 1991, to: 1998 },
  N44W:   { brand: 'Mitsubishi', model: 'Space Wagon', from: 1991, to: 1998 },

  // ─── Suzuki ──────────────────────────────────────────────────────────────
  MH21S:  { brand: 'Suzuki', model: 'Wagon R', from: 2003, to: 2008 },
  MH22S:  { brand: 'Suzuki', model: 'Wagon R', from: 2003, to: 2008 },
  MH23S:  { brand: 'Suzuki', model: 'Wagon R', from: 2009, to: 2012 },
  HA25:   { brand: 'Suzuki', model: 'Alto', from: 2009, to: 2014 },

  // ─── Isuzu ───────────────────────────────────────────────────────────────
  UBS69:  { brand: 'Isuzu', model: 'Trooper', from: 1991, to: 2002 },
  UBS73:  { brand: 'Isuzu', model: 'Trooper', from: 1991, to: 2002 },
