...
const fmtRM = (n) =>
  n == null
    ? "—"
    : `RM ${Number(n).toLocaleString("en-MY", { minimumFractionDigits: 0 })}`;
const startOfMonth = () => {
  const d = new Date();
...
function marginPct(sell, cost) {
  if (!sell) return null;
  return (((Number(sell) - (Number(cost) || 0)) / Number(sell)) * 100).toFixed(
    1,
  );
}
    ...
    setForm(
      prefill
        ? {
            ...EMPTY_FORM,
            ...prefill,
            cost_price: String(prefill.cost_price),
    ...
    >
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: "#6b7280", fontSize: 13, marginTop: 4 }}>
          Manage your product catalogue and track aftermarket revenue
        </p>
      </div>
          ...
          >
            ...
            <div style={{ padding: 14 }}>
              {prodLoading ? (
                ...
                <div>
                  <p
                    style={{ fontSize: 12, color: "#4b5563", marginBottom: 12 }}
                  >
                    No products yet. Click a suggestion to add it quickly:
                  </p>
                  <div
                    style={{
                      display: "grid",
                  ...
                  >
                    {SEEDS.map((s, i) => (
                      ...
                      >
                        ...
                        >
                          RM {s.selling_price.toLocaleString()} sell · RM{" "}
                          {s.cost_price.toLocaleString()} cost
                        </p>
                      </button>
                    ))}
                  </div>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          >
                            <span style={{ fontSize: 11, color: "#4b5563" }}>
                              Cost: {fmtRM(p.cost_price)}
                            </span>
                            <span style={{ fontSize: 11, color: "#9ca3af" }}>
                              Sell: {fmtRM(p.selling_price)}
                            </span>
                            <span
                              style={{
                                fontSize: 11,
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {summary?.avgPerDeal != null
                          ? fmtRM(summary.avgPerDeal)
                          : "—"}
                      </p>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <p
                        style={{
                          ...
                          margin: 0,
                          color:
                            summary?.attachRate != null
                              ? summary.attachRate >= 20
                                ? "#4ade80"
                                : "#fbbf24"
                              : "#6b7280",
                        }}
                ...
                <>
                  ...
                  {recentRows.map((r, i) => (
                    ...
                    >
                      ...
                      >
                        RM {Number(r.sold_price).toLocaleString()}
                      </span>
                    </div>
                  ))}
                </>
            ...
            >
              ...
              >
                ...
                >
                  {form.is_active ? (
                    <ToggleRight
                      style={{ width: 26, height: 26, color: "#4ade80" }}
                    />
                  ) : (
                    <ToggleLeft
                      style={{ width: 26, height: 26, color: "#4b5563" }}
                    />
                  )}
                </button>
              </div>
              ...
              >
                ...
                <button
                  onClick={() =>
                    setForm((p) => ({ ...p, track_stock: !p.track_stock }))
                  }
                  style={{
                    background: "none",
                    border: "none",
                ...
                >
                  {form.track_stock ? (
                    <ToggleRight
                      style={{ width: 26, height: 26, color: "#38bdf8" }}
                    />
                  ) : (
                    <ToggleLeft
                      style={{ width: 26, height: 26, color: "#4b5563" }}
