...
export const CAR_FIELDS  = 'id,slug,brand,model,variant,year,selling_price,original_price,mileage,transmission,fuel_type,body_type,state,colour,engine_cc,condition,previous_owners,auction_grade,interior_grade,is_recon,financing_type,images,status,created_at,seller_role,dealer_is_verified,seller_sold_count,payment_type,sambung_monthly,sambung_deposit,sambung_months_left';
