...
/**
 * Drop-in search input with live autocomplete from search_listing_terms RPC.
 *
 * Props:
 *   value        string  — controlled input value
 *   onChange     fn(val) — called on every keystroke
 *   onSubmit     fn(val) — called on Enter / form submit with raw text
 *   navigateTo   string  — base path to navigate on suggestion pick (e.g. '/showroom')
 *                          builds ?brand=X&model=Y&variant=Z and navigates immediately
 *   placeholder  string
