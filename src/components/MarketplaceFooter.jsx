  ...
  const NAV = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Smart Inventory',    to: '/shiftos#feat-inventory' },
        { label: 'Leads CRM',          to: '/shiftos#feat-crm' },
        { label: 'Revenue Analytics',  to: '/shiftos#feat-ownerpnl' },
        { label: 'F&I & Documents',    to: '/shiftos#feat-fi' },
        { label: 'Post-Sale Handover', to: '/shiftos#feat-postsale' },
