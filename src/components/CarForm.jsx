...
// CAR_DATA now lives in src/data/carData.js (imported at the top) so public
// pages can use the brand list without dragging this whole form onto the
// critical path. Re-exported for backward compatibility with existing importers.
export { CAR_DATA };
